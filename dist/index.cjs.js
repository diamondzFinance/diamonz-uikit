...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, cakePriceUsd = _a.cakePriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang, priceLink = _a.priceLink, _b = _a.socialsOverride, socialsOverride = _b === void 0 ? socials : _b;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null,
            ...
            React__default['default'].createElement(Flex, null, socialsOverride.map(function (social, index) {
                var Icon = Icons[social.icon];
                var iconProps = { width: "24px", color: "textSubtle", style: { cursor: "pointer" } };
                var mr = index < socialsOverride.length - 1 ? "8px" : 0;
                if (social.items) {
...
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu, certifications = props.certifications;
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React__default['default'].createElement(PanelBody, __assign({}, props)),
        certifications && certifications.map(function (entry) {
            return (React__default['default'].createElement("a", { target: "_blank", rel: "noreferrer", href: entry.href },
                React__default['default'].createElement("img", { src: entry.img })));
        }),
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, socialsOverride: socialsOverride, certifications: certifications }),
